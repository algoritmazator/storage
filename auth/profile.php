  ...
  <header>
    ...
    <a href="#">
      <div class="support_header_img">
        <img src="../img/setting_2040504.webp">
      </div>
      </a>
      <a href="#" >
...
document.getElementById('fileInput').addEventListener('change', function() {
    ...
    <a href="last_files.php" class="sup_aside_a_1">
      ...
      <img src="../img/free-icon-three-o-clock-clock-13435.webp">
      </div>
      Последнее
    </a><br>
    <a href="text_file.php" class="sup_aside_a_1">
      <div class="support_aside_img">
      <img src="../img/free-icon-open-file-4847498.webp">
      </div>Файлы
    </a><br>
    <a href="image_file.php" class="sup_aside_a_1">
      <div class="support_aside_img">
      <img src="../img/free-icon-image-gallery-3342176.webp">
      </div>
      Фото
    </a><br>
  </aside>
...
$select_query = "SELECT * FROM `file` WHERE `user_id` = ?";
if ($stmt = $connect->prepare($select_query)) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if (in_array($file_extension, ['jpg', 'jpeg', 'png', 'gif'])) {
            ...
            echo '<img src="../img/' . $file_extension . '.webp" alt="' . $row['filename'] . '">';
        } else {
            // Если тип файла не поддерживается, выводим текстовое сообщение
            echo '<p>Не удалось отобразить файл</p>';
        }
        ...
        echo '<div class="support_btn_profile"';
          ...
          echo '<input type="hidden" name="file_id" value="' . $row['id'] . '">';
          echo '<button id ="btn_delite_file" type="submit">
      
          </button>';
          echo '</form>';
          echo '<div class="ya-share2" data-curtain data-shape="round" data-color-scheme="blackwhite" data-limit="0" data-more-button-type="short" data-services="vkontakte,odnoklassniki,telegram,whatsapp"></div>';
          echo '</div>';
        echo '</div>';
    }
    $stmt->close();
