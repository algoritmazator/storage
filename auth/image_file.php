...
<a href="profile.php" class="sup_aside_a_1">
      ...
      <img src="../img/free-icon-home-1946436.webp">
      </div>
      Главная
    </a><br>
...
$select_query = "SELECT * FROM `file` WHERE `user_id` = ? AND (`filetype` = 'image/jpeg' OR `filetype` = 'image/png' OR `filetype` = 'image/gif')";
